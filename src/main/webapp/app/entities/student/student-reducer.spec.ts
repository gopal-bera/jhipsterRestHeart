...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './student.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_STUDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STUDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STUDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STUDENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STUDENT actions', async () => {
      const expectedActions = [
        {
