  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRestHeartApp.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Email" id="student-email" name="email" data-cy="email" type="text" />
              <ValidatedField label="Phone No" id="student-phoneNo" name="phoneNo" data-cy="phoneNo" type="text" />
              <ValidatedField label="Percentage" id="student-percentage" name="percentage" data-cy="percentage" type="text" />
              <ValidatedField label="Course" id="student-course" name="course" data-cy="course" type="text" />
