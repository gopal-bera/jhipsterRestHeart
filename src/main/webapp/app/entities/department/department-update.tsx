  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRestHeartApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Name" id="department-name" name="name" data-cy="name" type="text" />
              <ValidatedField label="University" id="department-university" name="university" data-cy="university" type="text" />
