...
class DepartmentResourceIT {
    ...
    public static Department createEntity() {
        Department department = new Department().name(DEFAULT_NAME).university(DEFAULT_UNIVERSITY);
        return department;
    }
    ...
    public static Department createUpdatedEntity() {
        Department department = new Department().name(UPDATED_NAME).university(UPDATED_UNIVERSITY);
        return department;
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).university(UPDATED_UNIVERSITY);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.university(UPDATED_UNIVERSITY);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).university(UPDATED_UNIVERSITY);
